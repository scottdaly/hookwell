...
export function materials() {
  ...
  M = {
    plaster: lam({ map: plaster, color: 0xf4e7cc }),
    plasterOchre: lam({ map: plaster, color: 0xdcb76e }),
    plasterRose: lam({ map: plaster, color: 0xe2b9a0 }),
    plasterGrey: lam({ map: plaster, color: 0xcfcbbd }),
    ashlar: lam({ map: ashlar, color: 0xd8d0bc }),
    ashlarDark: lam({ map: ashlar, color: 0xa39c8c }),
    tile: pho({ map: tile, specular: 0x5a78b0, shininess: 55 }),
    tileTeal: pho({ map: tileTeal, specular: 0x4f9aa0, shininess: 55 }),
    timber: lam({ map: timber, color: 0xcaa88a }),
    timberDark: lam({ map: timber, color: 0x7a5a44 }),
    ...
    ink: lam({ color: 0x1c2140 }),
    inkBlue: lam({ color: 0x2d3f78 }),
    wax: lam({ color: 0xa9281f }),
    ...
    pine: lam({ map: pine, color: 0xb7cfc0 }),
    pineTrunk: lam({ map: timber, color: 0x9a7a60 }),
    inkwood: lam({ map: ink, color: 0x8f9ad0 }),
    inkwoodTrunk: lam({ map: T.timberTex(), color: 0xc9bca0 }),
    rock: lam({ map: rock, color: 0xd0cfc9 }),
    bloom: lam({ map: bloom, color: 0xb4a9e6 }),
    bloomStalk: lam({ color: 0xe6dcc8 }),
    ley: pho({ color: 0x35b0cc, emissive: 0x0f4f8a, emissiveIntensity: 0.5, specular: 0xffffff, shininess: 120 }),
